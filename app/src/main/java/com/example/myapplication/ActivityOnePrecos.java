...
public class ActivityOnePrecos extends AppCompatActivity {
    ...
    private void chamarMainActivity(){
        Intent intent = new Intent(getApplicationContext(), ActivityTwoCalculos.class);
    ...
    private void verificadorIniciar(){
        if ((TextUtils.isEmpty(valorOleo.getText().toString()))&&
            ...
            Toast.makeText(ActivityOnePrecos.this, "Preencha um dos campos", Toast.LENGTH_SHORT).show();
        }  else {
